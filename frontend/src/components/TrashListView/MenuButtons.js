...
function MenuButtons({ setShowModal, setDeleteModal }) {
  return (
    <div>
      <button
        className="block py-4 pl-3 pr-12 md:pr-10 w-full text-left hover:bg-lightGrayHover focus:bg-lightGreen"
      ...
      <button
        ...
        className="block py-4 pl-3 pr-12 md:pr-10 w-full md:w-max text-left hover:bg-lightGrayHover focus:bg-lightGreen whitespace-nowrap"
      >
        <svg
          className="inline-block"
          width="17"
